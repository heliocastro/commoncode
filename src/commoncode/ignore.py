...
from commoncode import fileset, filetype, fileutils
...
def is_ignore_file(location):
    ...
    """
    return filetype.is_file(location) and fileutils.file_name(location) == ".scancodeignore"
...
ignores_Build_scripts = {  # noqa: N816
