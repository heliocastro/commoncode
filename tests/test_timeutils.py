...
from commoncode.timeutils import UTC, time2tstamp, tstamp2time
...
class TestTimeStamp(FileBasedTesting):
    ...
    def test_tstamp2time(self):
        ...
        assert (
            datetime(year=2010, month=11, day=12, hour=13, minute=14, second=15, microsecond=16, tzinfo=UTC())
            == dt_from_ts
        )
    ...
    def test_tstamp2time4(self):
        ...
        assert (
            datetime(year=2010, month=11, day=12, hour=13, minute=14, second=15, microsecond=0, tzinfo=UTC())
            == dt_from_ts
        )
    ...
    def test_tstamp2time9(self):
        ...
        assert (
            datetime(year=2010, month=6, day=30, hour=21, minute=26, second=40, microsecond=0, tzinfo=UTC())
            == dt_from_ts
        )
